...
public class LinearRegressionFoldsModified
{
    public void RunLinearRegressionFoldsModified(string pathCsv)
    {
        var utils = new Utils();
        ...
        //Salva o gráfico
        plot.SavePng("LinearRegressionFoldsModified.png", 600, 400);
    }
}
